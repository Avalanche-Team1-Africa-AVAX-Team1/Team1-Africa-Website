        ...
        <div className="relative py-8 sm:py-12 md:py-16 lg:py-24 xl:py-32 2xl:py-40 hover:cursor-pointer group px-4 sm:px-6 md:px-8 lg:px-12">
            ...
            <div className="relative w-fit mx-auto">
                ...
                <img
                    src={union}
                    alt="union"
                    className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform rotate-[-2deg] w-[120px] sm:w-[160px] md:w-[220px] lg:w-[300px] xl:w-[380px] 2xl:w-[460px] transition-all duration-700 ease-in-out opacity-0 scale-50 group-hover:opacity-100 group-hover:scale-100 z-10"
                />
