...
const Stats = () => {
    ...
    return (
        <div ref={statsRef} className='relative flex h-screen xl:py-10 lt-1920:h-auto lt-1440:py-20 lt-1024:py-16 pb-12 md:pb-16 flex-col justify-around md:justify-center items-center overflow-hidden'> {/* Reduce height on ≤1920 to prevent overlap; add bottom padding */}
            ...
            <img
                ...
                width={300}
                height={150}
                className='hidden xl:top-0 md:block absolute md:bottom-24 md:left-0 md:w-28 lg:bottom-24 lg:left-0 lg:w-48 xl:top-2 xl:left-0 xl:w-52 2xl:bottom-96 2xl:left-20 2xl:ml-0 2xl:w-[300px] rounded-xl pointer-events-none z-0' /> {/* Smaller and pushed out on tablets; scales up on larger screens */}
            <img
                src={event2}
                alt="event2"
                width={300}
                height={150}
                className='hidden md:block absolute md:top-10 md:right-0 md:w-28 lg:top-24 lg:right-0 lg:w-48 xl:top-56 xl:right-0 xl:w-52 2xl:top-96 2xl:right-20 2xl:mr-0 2xl:w-[300px] rounded-xl pointer-events-none z-0' /> {/* Smaller and pushed out on tablets; scales up on larger screens */}
