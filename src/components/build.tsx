    ...
    return (
        <div>
            ...
            <div className='flex flex-col lt-1024:flex-col md:flex-row justify-between w-full mb-12 lt-1024:mb-10 gap-8 lt-1024:gap-8 px-8 lt-1024:px-5 lt-768:px-4'>
                ...
                <div className='w-full md:w-[45%] '>
                    ...
                    <AnimatedText variant="fadeIn" delay={0.5}>
                        <MagneticButton className='w-fit fill-left hover:text-white border-2 border-gray-200 text-gray-700 px-6 py-3 lt-768:px-5 lt-768:py-2.5 rounded-full font-medium transition-colors flex items-center gap-2 group'>
                            Learn more
            ...
            <div className="-ml-8 lt-1024:ml-0 w-[calc(100%+4rem)] lt-1024:w-full px-8">
                <AnimatedSection staggerChildren={0.15} delay={0.2}>
                    {/* Build Section */}
                    <AnimatedItem className="bg-[#F1E228] cursor-pointer px-5 py-6 lt-1024:px-4 lt-1024:py-5 flex items-center hover:pb-10 lt-1024:hover:pb-8 transition-all duration-500 ease-in-out">
                    ...
                    {/* Create Section */}
                    <AnimatedItem className="bg-[#11B55A] cursor-pointer px-5 py-6 lt-1024:px-4 lt-1024:py-5 flex items-center hover:pb-10 lt-1024:hover:pb-8 transition-all duration-500 ease-in-out">
                        <div className="flex flex-col lt-1024:flex-col md:flex-row justify-between items-start lt-1024:items-start md:items-center w-full gap-4 lt-1024:gap-3">
                            <div className="flex-shrink-0">
                    ...
                    {/* Educate Section */}
                    <AnimatedItem className="bg-[#2996F3] cursor-pointer px-5 py-6 lt-1024:px-4 lt-1024:py-5 flex items-center hover:pb-10 lt-1024:hover:pb-8 transition-all duration-500 ease-in-out">
                        <div className="flex flex-col lt-1024:flex-col md:flex-row justify-between items-start lt-1024:items-start md:items-center w-full gap-4 lt-1024:gap-3">
                            <div className="flex-shrink-0">
