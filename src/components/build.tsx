...
const cards = [
    {
        id: 1,
        title: "Build",
        description: "We support developers and startups through grants, mentorship, and technical workshops to build impactful dApps on Avalanche.",
        icon: rocket,
        color: "#F1E228",
    ...
    },
    {
        id: 2,
        title: "Create",
        description: "We empower African artists, designers, and storytellers to express their creativity using Avalanche-powered NFTs and platforms.",
        icon: gamepad,
        color: "#11B55A",
    ...
    },
    {
        id: 3,
        title: "Educate",
        description: "Through training, university outreach, and online content, we bring Avalanche literacy to schools, hubs, and grassroots communities.",
        icon: scroll,
        color: "#2996F3",
        textColor: "text-white"
    }
