    ...
    return (
        <div className='py-16 lt-1440:py-14 lt-1024:py-12 lt-768:py-10 lt-480:py-8 flex flex-col items-center justify-center'> {/* Reduce top padding on smaller screens; keep 4K baseline */}
            ...
            <AnimatedText variant="fadeIn" delay={0.4}>
                <Link to="/gallery">
                    <MagneticButton className='w-fit btn-black px-6 py-3 mt-3 lt-1024:px-5 lt-1024:py-2.5 lt-768:px-4 lt-768:py-2 rounded-full font-medium transition-colors flex items-center gap-2 lt-768:gap-1.5 group'>
                        <span className="relative z-10">View Full Gallery</span>
                        {/* Icons scale with screen size */}
                        <img src={arrowup} alt="" width={20} height={20} className='lt-768:w-4 lt-768:h-4 relative z-10' />
                    </MagneticButton>
                </Link>
            </AnimatedText>
