                        ...
                        >
                            ...
                            >
                                <img
                                    src={discordIcon}
                                    alt="Discord"
                                    className={`w-6 h-6 transition-all duration-300 ${selectedPlatform === 'discord' ? 'brightness-0 invert' : ''
                                        }`}
                                />
                            </button>
                            ...
                            >
                                <img
                                    src={telegramIcon}
                                    alt="Telegram"
                                    className={`w-6 h-6 transition-all duration-300 ${selectedPlatform === 'telegram' ? 'brightness-0 invert' : ''
                                        }`}
                                />
                            </button>
                        </div>
